...
const ProductCard = ({ product }: ProductCardProps) => {
  ...
  return (
    <Link href={`/detail/${id}`}>
      <div className="flex flex-col items-center p-[10px] lg:pb-[25px] md:pb-[20px] mobile:w-[160px] md:w-[247px] lg:w-[300px] mobile:gap-[10px] md:gap-[20px] gap-[25px] rounded-lg bg-gray-35  ">
        <ImageComponent type="product" src={image} alt="이미지" />

        <div className="w-full flex flex-col lg:gap-[10px] md:gap-[10px] mobile:gap-[5px] lg:px-[10px] md:px-[6.5px] ">
