...
const ProductCard = ({ product }: { product: ProductTypes }) => {
  ...
  return (
    <Link href={`/${categoryId}/${id}`}>
      <div className="flex flex-col items-center justify-start pt-[10px] lg:pb-[20px] md:pb-[15px] mobile:pb-[10px] px-[10px] h-full mobile:w-full lg:max-w-[300px] mobile:gap-[10px] md:gap-[20px] gap-[25px] rounded-lg border-gray-35 bg-gray-25">
