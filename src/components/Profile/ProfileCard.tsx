...
const ProfileCard = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-around  bg-gray-25 w-[335px] h-[466px] lg:w-[340px] lg:h-[603px] md:w-[509px] md:h-[451] rounded-xl border border-solid border-gray-35">
      <ImageComponent
        type="profile"
      ...
      <div className=" flex flex-col items-center lg:gap-[20px]">
        ...
        <p className="text-gray-6E truncate">{profileData?.description}</p>
      </div>
