...
const TextBoxInput = () => {
  ...
  return (
    ...
    >
      <textarea
        className="scrollbar-hide w-full h-[66px] md:h-[106px] bg-black-25 text-gray-F1 text-[14px] lg:text-[16px] font-normal placeholder-gray-6 resize-none focus:outline-none leading-[20px] lg:leading-[22px]"
